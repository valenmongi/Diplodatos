...
Se utilizara un set con datos de 178 vinos de 3 clases distintas (59 de la 1, 71 de la 2 y 48 de la 3). La clase del vino se indica en la primera columna, y el resto de las columnas contienen datos como el porcentaje de alcohol, de acido malico, magensio, etc. Todas estas caracteristicas son de caracter continuo.
...
data[,2:14]=lapply(data[,2:14],normalize) # Normalizacion con min y max
data_sc[,2:14]=lapply(data_sc[,2:14],scale) # Normalizacion z score
```
